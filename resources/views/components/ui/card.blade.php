...
@props([
    'image' => null,
    'title' => 'Product Name',
    'description' => 'This card element can be used to display a product, post, or any other type of data.',
    'buttonText' => null,
    'buttonUrl' => '#'
])

<div {{ $attributes->merge(['class' => 'rounded-lg overflow-hidden border border-neutral-200/60 bg-white text-neutral-700 shadow-sm w-[380px]']) }}>
    @if ($image)
        <div class="relative">
